         ...
         <?php 
           ...
           if($select_accounts->rowCount() > 0){
              while($fetch_accounts = $select_accounts->fetch(PDO::FETCH_ASSOC)){   
                 ?>
      <tr>
         <td  data-label="user id"><?= $fetch_accounts['id']; ?></td>
         <td  data-label="nama"><?= $fetch_accounts['name']; ?></td>
         <td class="td1" data-label="email"><?= $fetch_accounts['email']; ?></td>
         <td  data-label="aksi">
           ...
           <?php
               ...
               echo '<p class="empty">tidak ada akun pengguna yang terdaftar!</p>';
            }
            ?>
         </td>
