...
if(isset($_POST['add_product'])){
   ...
   $image_01 = strip_tags($image_01);
   $image_size_01 = $_FILES['image_01']['size'];
   $image_tmp_name_01 = $_FILES['image_01']['tmp_name'];
   $image_folder_01 = './uploaded_img/'.$image_01;

   $image_02 = $_FILES['image_02']['name'];
   $image_02 = strip_tags($image_02);
   $image_size_02 = $_FILES['image_02']['size'];
   $image_tmp_name_02 = $_FILES['image_02']['tmp_name'];
   $image_folder_02 = './uploaded_img/'.$image_02;

   $image_03 = $_FILES['image_03']['name'];
   $image_03 = strip_tags($image_03);
...
if(isset($_GET['delete'])){
   ...
   unlink('./'.$fetch_delete_image['image_01']);
   unlink('./'.$fetch_delete_image['image_02']);
   unlink('./'.$fetch_delete_image['image_03']);
   ...
   <form action="" method="post" enctype="multipart/form-data">
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="number" min="0" class="box" required max="9999999999" placeholder="masukkan produk" onkeypress="if(this.value.length == 10) return false;" name="price">
         </div>
        <div class="inputBox">
...
<section class="show-products">
   ...
   <div class="box">
      ...
      <div class="price">Rp.<span><?= $fetch_products['price']; ?></span>,00</div>
      <div class="details"><span><?= $fetch_products['details']; ?></span></div>
      <div class="flex-btn">
         <a href="update_product.php?update=<?= $fetch_products['id']; ?>" class="option-btn">perbarui</a>
         <a href="products.php?delete=<?= $fetch_products['id']; ?>" class="delete-btn" onclick="return confirm('anda yakin hapus produk ini?');">hapus</a>
      </div>
   </div>
   <?php
         }
